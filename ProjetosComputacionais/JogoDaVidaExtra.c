...
main()
{
    ...
    while(menu == 0)//Laço de repetição do menu
    {
        system("clear");
        ...
        system("clear");
        printf("Deseja usar algum padrão inicial ou uma forma livre?\n\n1.Formas Geometricas\n2.Aleatorio\n3.Desenho livre\n0.Começar de novo\n");//Menu para padrão inicial
        scanf("%d", &menu);
...
void preencheMatrizLivre(int **m,int l,int c)//Usuario preenche a tabela como quiser
{
    ...
    l -= 2;//Correçao para imprimir e editar apenas o que se pode acessar
    c -= 2;
