...
main()
{
    ...
    matriz = alocaMatriz(l+2, c+2);// Aloca memoria para a matriz, com duas colunas e linhas extras para a borda do tabuleiro
    aux = alocaMatriz(l+2, c+2);// Aloca a matriz auxiliar identica a original
